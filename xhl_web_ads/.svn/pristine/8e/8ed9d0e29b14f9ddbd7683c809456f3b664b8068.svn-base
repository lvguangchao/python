...
ywl.on_init = function (cb_stack, cb_args) {
    ...
    var host_table_options = {
        ...
        data_source: {
            type: 'ajax-post',
            url: '/income/close/list?account_type=2'
        },
        ...
        columns: [
            ...
            },
            {
                ...
                key: "anchor_balance",
                width: 40,
                render: 'format_incomeAnchor',
                fields: {income: 'anchor_balance', package_id: "package_id", package_name: "package_name"}
            },
            {
                title: "公会结算金额",
                key: "union_balance",
                width: 40,
                render: 'format_incomeUnion',
                fields: {income: 'union_balance', package_id: "package_id", package_name: "package_name"}
            },
            {
                title: "平台结算金额",
                key: "plat_balance",
                width: 40,
                render: 'format_incomePlat',
                fields: {income: 'plat_balance', package_id: "package_id", package_name: "package_name"}
            },
            {
                title: "经纪人结算金额",
                key: "agent_balance",
                width: 40,
                render: 'format_incomeAgent',
                fields: {income: 'agent_balance', package_id: "package_id", package_name: "package_name"}
            },
            {
                title: "结算总金额",
                key: "",
            ...
            {
                title: "关账时间", key: "balance_last_time", width: 30, render: 'format_timestatus',
                fields: {logtime: 'log_time', status: 'status'}
            },
            {
...
ywl.on_host_table_created = function (tbl) {
    ...
    tbl.on_cell_created = function (row_id, col_key, cell_obj) {
        if (col_key === 'select_all') {
            ...
            $(cell_obj).find('[ywl-btn-settle]').click(function () {
                ...
                ywl.ajax_post_json('/incomeanchor/close/settle', {
    ...
    tbl.on_render_created = function (render) {
        ...
        render.format_incomeAnchor = function (row_id, fields) {
            ...
            return '<a href=/incomeanchor/close/list?account_type=2&package_id=' + fields.package_id + '&type=1&total=' + temp + '&package_name=' + fields.package_name + '  target="_blank">￥' + temp + '</a>'
        };
        render.format_incomePlat = function (row_id, fields) {
            ...
            return '<a href=/incomeanchor/close/list?account_type=2&package_id=' + fields.package_id + '&type=4&total=' + temp + '&package_name=' + fields.package_name + '  target="_blank">￥' + temp + '</a>'
        };
        render.format_incomeUnion = function (row_id, fields) {
            ...
            return '<a href=/incomeanchor/close/list?account_type=2&package_id=' + fields.package_id + '&type=2&total=' + temp + '&package_name=' + fields.package_name + '  target="_blank">￥' + temp + '</a>'
        };
        render.format_incomeAgent = function (row_id, fields) {
            ...
            return '<a href=/incomeanchor/close/list?account_type=2&package_id=' + fields.package_id + '&type=3&total=' + temp + '&package_name=' + fields.package_name + '  target="_blank">￥' + temp + '</a>'
        };
        ...
        render.format_timestatus = function (row_id, fields) {

            var temp = '未知'
            if (fields.status == 2) {
                var date=fields.logtime?fields.logtime.replace("T", " "):'--'
                temp = '<span class="badge badge-primary mono">' + date + ' </span>';
            } else {
                temp = '<span class="badge badge-danger mono">未关账</span>'
            }
            return temp
