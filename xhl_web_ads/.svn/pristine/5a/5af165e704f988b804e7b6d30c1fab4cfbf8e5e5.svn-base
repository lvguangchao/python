<%!
    page_title_ = '播放记录'
    page_menu_ = ['audit', 'playrecord']
    page_id_ = 'playrecord'
%>
<%inherit file="../../page_base.mako"/>
<%block name="extend_js">
     <script type="text/javascript" src="${ static_url('plugins/laydate/laydate.js') }"></script>
    <script type="text/javascript" src="${ static_url('js/ads_manager/playRecord/playRecord.js') }"></script>
    ...
    <div class="box" id="playrecord-list">
        ...
        <div class="page-filter" style="height: auto">
            <div class="" style="float:right;">
                ...
                <a href="javascript:;" class="btn btn-sm btn-primary" ywl-filter="import"><i class="glyphicon glyphicon-import"></i> 导入</a>
            ...
            <div class="input-group input-group-sm" ywl-filter="task_id" style="display:inline-block;">
                <input type="text" class="form-control" id="task_id" placeholder="task_id " style="display:inline-block;"
                       maxlength="20">
            </div>
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" id="version-list-action">
                       <div class="form-horizontal">
                           ...
                           <div class="form-group form-group-sm">
                               <label for="comment" class="col-sm-3 control-label"><strong>excel处理结果：</strong></label>
                               <div class="col-sm-6">
                                    <textarea id="excel_error" style="height: 100px;width: 290px;color: red;background: white;" type="text"
...
<div class="modal fade" id="dialog-credit-info" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width: 650px">
            <div class="modal-header">
                <h3 class="modal-title">更新信用分日期选择</h3>
            </div>
            <div class="modal-body">
                <form enctype="multipart/form-data">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group form-group-sm">
                            <label for="" class="col-sm-3 control-label"><strong>请选择日期</strong></label>
                            <div class="col-sm-6" id="shot_path">
                                <input id="credit_time" type="text" class="form-control" placeholder="时间 "
                                       style="display:inline-block;"
                                       maxlength="20">
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-primary" id="btn-save"><i class="fa fa-check fa-fw"></i> 确定
                </button>
                <button type="button" class="btn btn-sm btn-default" data-dismiss="modal"><i
                        class="fa fa-close fa-fw"></i> 取消
                </button>
...
##             value:GetDateStr(0),
        ...
        laydate.render({
            elem: '#dialog-credit-info #credit_time',
##             value:GetDateStr(0),
            done: function (value, date, endDate) {
                $("#begin_time").val(value);
            }
