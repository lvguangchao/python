...
ywl.on_init = function (cb_stack, cb_args) {
    ...
    ywl.create_table_filter_search_box(host_table, dom_id + " [ywl-filter='nick_name']",{},"nick_name");
...
ywl.on_host_table_created = function (tbl) {
    ...
    tbl.on_render_created = function (render) {
        ...
        render.make_action_btn = function (row_id, fields) {
            var ret = [];
            ret.push('<a href="javascript:;" class="btn btn-sm btn-info" protocol=' + fields.protocol + ' ywl-btn-detail="' + fields.ID + '">信用分记录</a>&nbsp');
            ret.push('<a href="javascript:;" class="btn btn-sm btn-warning" protocol=' + fields.protocol + ' ywl-btn-edit="' + fields.ID + '">调整信用分</a>&nbsp');
            return ret.join('');
        }
