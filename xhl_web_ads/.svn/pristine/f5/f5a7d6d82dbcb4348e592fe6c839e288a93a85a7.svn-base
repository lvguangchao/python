<%!
    page_title_ = '结算(关账前)'
    page_menu_ = ['financial', 'incomeclose']
    page_id_ = 'incomeclose'
%>
<%inherit file="../../page_base.mako"/>

<%block name="extend_js">
    <script type="text/javascript"
            src="${ static_url('js/ads_manager/income_close_account/imcomePack_close.js') }"></script>
    ...
    <div class="box" id="contractpackageinfo-list">
        ...
        <div class="page-filter">
            ...
            <div class="">
                ...
                <div class="input-group-btn" ywl-filter="income_status" style="display:inline-block;margin-left:-4px;">
                 ...
                 <div class="input-group input-group-sm" ywl-filter="begin_time" style="display:inline-block;">
                <input id="begin_time" type="text" class="form-control" placeholder="开始时间 "
                       style="display:inline-block;"
                       maxlength="20">
            </div>
                <div class="input-group input-group-sm" ywl-filter="end_time" style="display:inline-block;">
                <input id="end_time" type="text" class="form-control" placeholder="结束时间 "
                       style="display:inline-block;"
                       maxlength="20">
            </div>
                 <div class="input-group input-group-sm" ywl-filter="financial_number" style="display:inline-block;">
                <input id="financial_number" type="text" class="form-control" placeholder="财务编号 "
                       style="display:inline-block;"
                       maxlength="20">
            </div>
                <div class="input-group input-group-sm" ywl-filter="search" style="display:inline-block;vertical-align: top;">
                    <input type="text" class="form-control" placeholder="搜索 套餐名称 " style="display:inline-block;"
                           maxlength="20">
