...
ywl.on_init = function (cb_stack, cb_args) {
    ...
    $("[ywl-filter='export']").click(function () {
        ...
        $.get("/incomeanchor/close/export?account_type=1&package_id=" + package_id + "&unionid=" + unionid + "&income_log_id="+income_log_id + "&income_type=" + income_type + "&room_id=" + room_id+
    ...
    $.get("/unionList4all/list", {}, function (ret) {
        var auxArr = [];
