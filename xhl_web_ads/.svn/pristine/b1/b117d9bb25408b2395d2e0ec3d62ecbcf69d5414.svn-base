<%!
    page_title_ = '黑名单'
    page_menu_ = ['market', 'blacklistinfo']
    page_id_ = 'blacklistinfo'
%>
<%inherit file="../../page_base.mako"/>
<%block name="extend_js">
    <script type="text/javascript"
            src="${ static_url('js/ads_manager/blacklist_info/blacklist.js') }"></script>
    <script type="text/javascript"
    ...
    <div class="box" id="blacklist-list">
        ...
        <div class="page-filter">
             <div class="" style="float:right;">
                <a href="javascript:void (0);" onclick="flushschedule();" class="btn btn-sm btn-primary"
                   ywl-filter="flush"><i class="glyphicon glyphicon-refresh"></i> 刷新广告</a>
            </div>
                    ...
                    <form enctype="multipart/form-data" id="version-list-action">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group form-group-sm">
                                ...
                                <div class="col-sm-6">
                                    <input id="ads_schedule_id" type="text" maxlength="7" class="form-control"
