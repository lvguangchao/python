...
ywl.on_init = function (cb_stack, cb_args) {
    ...
    var host_table_options = {
        ...
        columns: [
            ...
            },
            {
                ...
                fields: {ID: 'ads_id', protocol: 'ads_id',close_account:'close_account'}
            }
    ...
    // $(dom_id + " [ywl-filter='updateCredit']").click(function () {
    //     $("#dialog-credit-info").modal();
    // });
