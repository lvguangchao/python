...
ywl.on_init = function (cb_stack, cb_args) {
    ...
    $("[ywl-filter='export']").click(function () {
        ...
        $.get("/incomeanchor/export?package_id=" + package_id+"&unionid="+unionid+"&income_log_id="+income_log_id+"&income_type="+income_type+"&room_id="+room_id+
    ...
    // ywl.create_table_filter_union_list(host_table,  "[ywl-filter='union_id']");
