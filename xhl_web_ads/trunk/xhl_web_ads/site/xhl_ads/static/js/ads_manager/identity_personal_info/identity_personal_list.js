...
ywl.on_init = function (cb_stack, cb_args) {
    ...
    ywl.create_table_filter_search_box(host_table, dom_id + " [ywl-filter='id_user']", "", "id_user");
...
ywl.on_host_table_created = function (tbl) {
    ...
    tbl.on_cell_created = function (row_id, col_key, cell_obj) {
        if (col_key === 'select_all') {
            ...
            $(cell_obj).find('[ywl-btn-edit]').click(function () {
                ...
                $("#demo").modal();
                document.getElementById("id_user_name").value = id_user_name.toString();
                document.getElementById("id_number").value = id_number.toString();
                document.getElementById("bank_name").value = bank_name.toString();
                document.getElementById("bank_card_number").value = bank_card_number.toString();
                document.getElementById("hold_user_name").value = hold_user_name.toString();
                document.getElementById("bank_sub_name").value = bank_sub_name.toString();
                document.getElementById("qq_number").value = qq_number.toString();
                ...
                $('#btn-save').click(function () {
                    ...
                    form.append("identity_id", identity_id);
                    form.append("id_user_name", id_user_name);
                    form.append("id_number", id_number);
                    form.append("bank_name", bank_name);
                    form.append("bank_card_number", bank_card_number);
                    form.append("hold_user_name", hold_user_name);
                    form.append("bank_sub_name", bank_sub_name);
                    form.append("qq_number", qq_number);
                    xhr.open("post", "/identitypersonal/edit", false);
                    xhr.send(form);
    ...
    tbl.on_render_created = function (render) {
        ...
        render.make_action_btn = function (row_id, fields) {
            ...
            ret.push('<a href="javascript:;" class="btn btn-sm btn-primary" identity_id=' + fields.identity_id + ' id_user_name=' + fields.id_user_name + ' id_number=' + fields.id_number + ' bank_name=' + fields.bank_name + ' bank_card_number=' + fields.bank_card_number + ' hold_user_name=' + fields.hold_user_name + ' bank_sub_name=' + fields.bank_sub_name + ' qq_number=' + fields.qq_number + ' ywl-btn-edit="' + fields.identity_id + '">修改</a>&nbsp');
            return ret.join('');
        };
