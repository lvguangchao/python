...
ywl.on_init = function (cb_stack, cb_args) {
    ...
    var host_table_options = {
        ...
        data_source: {
            type: 'ajax-post',
            url: '/income/close/list?account_type=1'
        },
        ...
        columns: [
            ...
            {title: "关账时间", key: "log_time", width: 30,render: 'format_timestatus',
...
ywl.on_host_table_created = function (tbl) {
    ...
    tbl.on_render_created = function (render) {
        ...
        render.format_incomeAnchor = function (row_id, fields) {
            ...
            return '<a href=/incomeanchor/close/list?account_type=1&package_id='+fields.package_id+'&type=1&total='+temp+'&package_name='+fields.package_name+  '  target="_blank">￥'+temp+'</a>'
        };
        render.format_incomePlat = function (row_id, fields) {
            ...
            return '<a href=/incomeanchor/close/list?account_type=1&package_id='+fields.package_id+'&type=4&total='+temp +'&package_name='+fields.package_name+  '  target="_blank">￥'+temp+'</a>'
        };
        render.format_incomeUnion = function (row_id, fields) {
            ...
            return '<a href=/incomeanchor/close/list?account_type=1&package_id='+fields.package_id+'&type=2&total='+temp+ '&package_name='+fields.package_name+ '  target="_blank">￥'+temp+'</a>'
        };
        render.format_incomeAgent = function (row_id, fields) {
            ...
            return '<a href=/incomeanchor/close/list?account_type=1&package_id='+fields.package_id+'&type=3&total='+temp+ '&package_name='+fields.package_name+ '  target="_blank">￥'+temp+'</a>'
        };
