<%!
    page_title_ = '播放记录'
    page_menu_ = ['financial', 'playrecord4income']
    page_id_ = 'playrecord4income'
%>
<%inherit file="../../page_base.mako"/>
<%block name="extend_js">
    <script type="text/javascript" src="${ static_url('plugins/laydate/laydate.js') }"></script>
    <script type="text/javascript"
            src="${ static_url('js/ads_manager/playRecord4income/playRecord4income.js') }"></script>
...
##                         class="glyphicon glyphicon-folder-open"></i> 导出</a>
            ...
            <div class="input-group input-group-sm" ywl-filter="play_id" style="display:inline-block;">
                <input type="text" class="form-control" id="play_id" placeholder="play_id "
    ...
    ##             </div>
        ...
        <table class="table table-striped table-bordered table-hover table-data no-footer dtr-inline"
               toc-table="playrecord-list"></table>
        <!-- end table -->
                    ...
                    <form enctype="multipart/form-data" id="version-list-action">
                        ...
                        <div class="form-horizontal">
                            <div class="form-group form-group-sm" id="vtype-div">
                                ...
                                <div class="col-sm-6">
                                    <input id="income" min="0" type="number"
                                           oninput="if(value.length>8)value=value.slice(0,8)" class="form-control"/>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" id="version-list-action">
                        <div class="form-horizontal">
                            <div class="form-group form-group-sm" id="vtype-div">
                                <label for="ads_time"
                                       class="col-sm-3 control-label"><strong>请选择excel文件：</strong></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group form-group-sm">
                                ...
                                <div class="col-sm-6">
                                    <textarea id="excel_error"
                                              style="height: 100px;width: 290px;color: red;background: white;"
                                              type="text"
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" id="needschedule-list-action">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group form-group-sm">
                                <label for="anchor_alloc_type"
                                       class="col-sm-3 control-label"><strong>播放类型：</strong></label>
                                <div class="col-sm-6">
