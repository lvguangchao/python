<%!
    page_title_ = 'group管理'
    page_menu_ = ['market', 'needgroupinfo']
                              ...
                              <div class="form-group form-group-sm">
                                ...
                                <div class="col-sm-6">
                                    <div class="btn-group"  aria-label="...">
                                        ...
                                        <button type="button" id="btneed_id1" value="1" ><i class="glyphicon glyphicon-saved"></i>apply</button>
                                    </div>
                            ...
                            <div class="form-group form-group-sm">
                                ...
                                <div class="col-sm-6">
                                    <div class="btn-group" aria-label="...">
                                        ...
                                        <button type="button" id="btneed_id2" ><i class="glyphicon glyphicon-saved"></i>apply</button>
                                    </div>
